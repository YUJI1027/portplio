...
※上記の課題を解決するために、文部科学省「日本食品標準成分表2020年版（八訂）」（https://www.mext.go.jp/a_menu/syokuhinseibun/mext_00001.html）のデータを加工し、GAS（Google Apps Script）を通して幅広い食材のカロリーを取得できるのではないかと仮説し検証している最中です。
